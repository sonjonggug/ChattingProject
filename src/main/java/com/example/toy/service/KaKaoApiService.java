...
public class KaKaoApiService {
	...
	public String Start(String talk) {
          ...
          jsonData.put("max_tokens", 150); // 생성할 결과의 최대 글자 수 
          jsonData.put("n", 1); // 생성할 결과 수
          jsonData.put("temperature", 0.9); // 0 초과 1 이하의 실수 값 사용 가능 , temperature 수치가 높을수록 더 창의적인 결과가 생성됨
          jsonData.put("top_p", 0.85); // 0 이상 1 이하의 실수 값 사용 가능 ,  top_p 수치가 높을수록 더 창의적인 결과가 생성됨
